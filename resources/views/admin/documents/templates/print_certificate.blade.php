...
<head>
  <meta charset="utf-8">
  <title>Certificate of Residency - {{ $control_no }}</title>
  <style>
    @page {
      margin: 40px 45px;
      size: A4;
...
<body>
  ...
  <div class="container">
    <div class="center">
      ...
      <div class="title">BARANGAY CERTIFICATE OF RESIDENCY</div>
    ...
    <div class="content">
      ...
      <p style="text-align: justify;">
        He/She is personally known to me to be a law-abiding citizen and has a good moral character. Record of this barangay has shown that he/she has not committed nor been involved in any kind of unlawful activities in this barangay.
      </p>
      ...
      <p style="text-align: justify;">
        Issued this <strong>{{ $day ?? date('d') }}</strong> day of <strong>{{ $month ?? date('F') }}</strong>,
